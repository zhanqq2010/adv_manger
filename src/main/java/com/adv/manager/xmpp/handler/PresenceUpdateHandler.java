                    ...
                    try {
                         ...
                         if(notifications != null && notifications.size() > 0){
                         	for(Notification notification: notifications){
                         		...
                         		String mode = notification.getMode();
                         		String imagUrl = notification.getImgUrl();
                         		notificationManager.sendNotifcationToUser(apiKey, session.getUsername(), title, message, uri, imagUrl,mode, false);
