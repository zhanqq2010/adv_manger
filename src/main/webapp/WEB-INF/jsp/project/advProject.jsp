...
<!-- page heading start-->
    ...
    <div class="wrapper">
             <div class="row">
                ...
                <div class="clearfix">
                    <div class="btn-group">
                      <a href="${pageContext.request.contextPath}/project/goAddAdvProject/1" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> 添加链接项目 </a>
                    </div>
                    <div class="btn-group">
                      <a href="${pageContext.request.contextPath}/project/goAddAdvProject/2" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> 添加apk项目 </a>
                    </div>
                ...
                <tr>
                    ...
                    <th class="col-lg-1 col-xs-1">广告展示类型</th>
                    <th class="col-lg-1 col-xs-1">已下发次数</th>
                    <th class="col-lg-1 col-xs-1">状态</th>
                    <th class="col-lg-1 col-xs-1">操作</th>
                </tr>
                </thead>
                <tbody>
	              <c:forEach var="advProject" items="${advProjects}">
						<tr class="">
					        <td>${ advProject.pid}</td>
				       	    <td>${ advProject.pname}</td>
				       	    <td>${ advProject.type}</td>
				       	    <td>${ advProject.count}</td>
				       	    <td>${ advProject.status}</td>
