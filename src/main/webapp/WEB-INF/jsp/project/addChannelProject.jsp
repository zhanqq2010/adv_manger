                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="${pageContext.request.contextPath}/project/createChannelProject/${partnerName}">
                                  	<!-- 厂商的操作类型 -->
                                    ...
                                    <div class="form-group ">
                                        <label for="lastname" class="control-label col-lg-2"><label>新增扣量:</label></label>
                                        <div class="col-lg-3">
                                            <input class=" form-control" id="newUserDeduct" name="newUserDeduct" type="text"" required />*(需要扣掉的量,范围0~1,小数)
                                        </div>
                                    </div>
									<div class="form-group">
