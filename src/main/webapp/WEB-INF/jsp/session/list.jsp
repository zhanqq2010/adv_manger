 ...
 <!-- page heading start-->
    ...
    <div class="wrapper">
             <div class="row">
                ...
                <thead>
                <tr>
                    <th class="col-lg-1 col-xs-1">Username</th>
                    <th class="col-lg-1 col-xs-1">Resource</th>
                    <th class="col-lg-7 col-xs-7">Status</th>
                    <th class="col-lg-1 col-xs-1">Presence</th>
                    <th class="col-lg-1 col-xs-1">Client IP</th>
                    <th class="col-lg-1 col-xs-1">Created</th>
                </tr>
                </thead>
                <tbody>
			...
			<tr>
				...
				<td>
					...
					<c:when test="${sess.presence eq 'Online'}">
						<img src="${pageContext.request.contextPath}/static/images/user-online.png" />
					</c:when>
					<c:when test="${sess.presence eq 'Offline'}">
						<img src="${pageContext.request.contextPath}/static/images/user-offline.png" />
					</c:when>
					<c:otherwise>
						<img src="${pageContext.request.contextPath}/static/images/user-away.png" />
					</c:otherwise>
					</c:choose>
