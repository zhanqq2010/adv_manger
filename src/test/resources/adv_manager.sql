...
CREATE TABLE `app` (
  ...
  `run_pic` varchar(500) DEFAULT NULL,
  `simpledes` varchar(500) DEFAULT NULL,
  `description` varchar(1000) DEFAULT NULL,
  `app_size` varchar(20) DEFAULT NULL,
  ...
  `dcpid` varchar(50) DEFAULT NULL,
  `dsid` varchar(50) DEFAULT NULL,
  `ddl_url` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for channelproject
-- ----------------------------
DROP TABLE IF EXISTS `channelproject`;
CREATE TABLE `channelproject` (
  ...
  `new_user_deduct` decimal(11,10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of channelproject
-- ----------------------------
...
INSERT INTO `country` VALUES ('233', 'Br. Virgin Is', '英属维尔京群岛', 'South America', 'VGB');
...
INSERT INTO `country` VALUES ('243', 'Saint Lucia', '圣卢西亚', 'South America', 'LCA');
...
-- ----------------------------
-- Table structure for productproject
-- ----------------------------
...
-- ----------------------------
-- Records of productproject
-- ----------------------------
INSERT INTO `productproject` VALUES ('713', 'b1084a10237c46ce969e14280ffeefeb', 'aaaa', '3', 'cs1', '122.00', null, '33', '1');
